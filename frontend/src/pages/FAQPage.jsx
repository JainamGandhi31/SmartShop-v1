...
const Faq = () => {
  ...
  // As it is fully static we can make it inside this FAQPage component
  return (
      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@smartshop.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@smartshop.com, or by calling us at (555) 123-4567
                between the hours of 9am and 5pm EST everyday.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we are only shipping in India.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept payment via paypal and credit/debit card like  Visa, mastercard. Also we have a Cash On Delivery option available.
              </p>
            </div>
          )}
        </div>
